...
?>
            ...
            <h5>Barangay Household</h5>
                ...
                <a href ="secHupload.php" class="btn btn-info" ><i class="fas fa-upload"></i></a>
                </div>    
                        <div class="card-body">
...
<!-- ############################################################################################################ -->
    ...
    <input type = "text" name="browP_idS" list="browP_idS" class="text1 form-control" placeholder ="Select ID" required >
            <datalist id="browP_idS">
