...
?>             <!-- DataTales Example -->
                ...
                <!-- <button type="button" class="btn btn-info sidebot">Add Officials</button> -->
                        ...
                        <div id="London" class="card-body ">
                            ...
                            $statement =$conn->prepare('SELECT * from certificate INNER JOIN resident ON certificate.resident_ID  = resident.resident_ID INNER JOIN purok ON certificate.P_id = purok.P_id WHERE Approve ="Approve" AND Certificate ="Barangay Indigency" AND Remarks =""');
                            $statement->execute();
      ...
      <form style ="display: inline-block"method ="POST" action="Certificate/Indigency.php" >
...
<button type="submit" class="btn btn-sm btn-info" name ="submit">Print</button>
                                ...
                                <!-- target="_blank" onClick="javascript: setTimeout(function(){location.reload();}, 1000);return true; -->
                            </tr>
                ...
                <div id="Paris" class="card-body ">
                            ...
                            $statement =$conn->prepare('SELECT *from certificate INNER JOIN resident ON certificate.resident_ID  = resident.resident_ID INNER JOIN purok ON certificate.P_id = purok.P_id WHERE Approve ="Approve" AND Certificate ="Barangay Indigency" AND Remarks ="Done"');
                            $statement->execute();
                            while($certificate=$statement->fetch()){
