...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion yello" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="bhwdash.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="bhwdash.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="bhwResident.php">Manage Resident</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="bhwpatient.php">Manage Patient</a>
                        <a class="collapse-item" href="bhwpatientR.php">Patient Record</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilitiesH" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="bhwhousehold.php">Manage Household</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities3" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="bhwmedicine.php">Manage Medicine</a>
                        <a class="collapse-item" href="bhwmedstock.php">Out of Stock</a>
                        <a class="collapse-item" href="bhwmedexpire.php">Expired</a>
                        <!-- <a class="collapse-item" href="utilities-animation.html">Animations</a>
                        <a class="collapse-item" href="utilities-other.html">Other</a> -->
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="bhwchild.php">Manage Child Info</a>
                        <!-- <a class="collapse-item" href="utilities-other.html">Other</a> -->
                    </div>
                </div>
            </li>
        ...
        <li class="nav-item">
                ...
                <div id="collapseUtilities0" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="bhwmaternity.php">Maternity info</a>
                        <!-- <a class="collapse-item" href="utilities-border.html">Borders</a>
                        <a class="collapse-item" href="utilities-animation.html">Animations</a>
                        <a class="collapse-item" href="utilities-other.html">Other</a> -->
                    </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilitiesP" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="bhwpurok.php">View Purok</a>
                        <!-- <a class="collapse-item" href="utilities-border.html">Borders</a>
                        <a class="collapse-item" href="utilities-animation.html">Animations</a>
                        <a class="collapse-item" href="utilities-other.html">Other</a> -->
                    </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities4" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <!-- <a class="collapse-item" href=".html">Patient record</a>   -->
                        <a class="collapse-item" href="bhwmedinventory.php">Inventory record</a> 
                        <a class="collapse-item" href="bhwvaccineReport.php">Imunization Report</a>
                        <a class="collapse-item" href="bhw4ps.php">4P's record</a> 
                        <a class="collapse-item" href="bhwSenior.php">Senoir Citizen record</a> 
                        <a class="collapse-item" href="bhwchildReport.php">New Born Baby</a> 
                        <a class="collapse-item" href="bhwMaternityR.php">Maternity</a> 
                        <a class="collapse-item" href="bhwprenatalR.php">Prenatal</a> 
                        <a class="collapse-item" href="bhwpwd.php">Pwd</a> 
                        <a class="collapse-item" href="bhwdead.php">Deceased</a> 
...
<?php 
                    ...
                    <a class="nav-link dropdown-toggle" href="bhwmedexpire.php" >
...
?>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">BHW/<?php echo $_SESSION["bhfullname"] ?></span>
                ...
                <?php
                 require_once("Account/bhviewaccount.php");
                 require_once("Account/bchangepass.php");
                 require_once("logout/bhlogout.php");
    ?>