...
<button onclick ="window.print();" id ="print2" class="btn btn-info" ><i class="fas fa-print"></i></button>
                        ...
                        <div class="card-body">
                            ...
                            $statement =$conn->prepare("SELECT *, resident.resident_ID, resident.R_firstname, resident.R_Lastname ,resident.R_gender,resident.R_birthdate,resident.R_Birthplace from maternity INNER JOIN resident on maternity.resident_ID = resident.resident_ID WHERE Dates BETWEEN '$Date1' AND '$Date2'");
                            $statement->execute();
...
<div class="card-body">
                            ...
                            $statement =$conn->prepare("SELECT *, resident.resident_ID, resident.R_firstname, resident.R_Lastname ,resident.R_gender,resident.R_birthdate,resident.R_Birthplace from maternity INNER JOIN resident on maternity.resident_ID = resident.resident_ID");
                            $statement->execute();
                            while($Patient=$statement->fetch()){
                                $today =date("Y-m-d");
                                $bdate1=$Patient['R_birthdate'];
