...
?>
            ...
            <h5>Settled Blotter</h5>
                     ...
                     <div class="card-body">
                            ...
                            $statement =$conn->prepare("SELECT * from tblblotter INNER JOIN resident On tblblotter.respondent = resident.resident_ID WHERE status='Settled'");
                            $statement->execute();
                           ...
                           -->
                            ...
                            <?php include('Blottersinfo/SecSettledmodal.php'); ?>
...
<div class="modal fade" id="delmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form  action="Blottersinfo/SecSettledDel.php" method="post" enctype="multipart/form-data">
