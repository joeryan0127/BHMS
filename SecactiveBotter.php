                ...
                <!-- <button type="button" class="btn btn-info sidebot">Add Officials</button> -->
                     ...
                     <div class="card-body">
                           ...
                           <a href="#edit2_<?php echo $Blotter['id']; ?>" class="btn btn-light" data-toggle="modal"><span class="fas fa-eye"></span></a>
                            ...
                            <a href="#edit_<?php echo $Blotter['id']; ?>" class="btn btn-success btn-sm" data-toggle="modal"><span class="fas fa-check"></span></a>

                            <?php include('Blottersinfo/SecActivemodal.php'); ?>
...
<div class="modal fade" id="delmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
           ...
           <h5 class="modal-title" id="exampleModalLabel">Blotter</h5>
                ...
                <form  action="Blottersinfo/SecActiveDel.php" method="post" enctype="multipart/form-data">

                <input type ="hidden" class = "text1" name="id1" id="id1"  readonly>


               <center>Are you sure this is unsettled Case?</center>
               
               </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">No</button>
                    <button type="submit" class="btn btn-danger" name ="del">Yes</button>
                </div>
