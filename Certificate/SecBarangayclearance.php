...
if(!$id){
    ...
    header('Location: ../SecBarangayclear.php');
...
<input type="button" onclick="location.href='../SecBarangayclear.php'" style="color:white;background-color:DodgerBlue;padding:0.5%;width=100%;" value="Back"id ="print" />
