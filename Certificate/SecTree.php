...
if(!$id){
    ...
    header('Location: ../SecClearance.php');
...
<input type="button" onclick="location.href='../SecClearance.php'" style="color:white;background-color:DodgerBlue;padding:0.5%;width=100%;" value="Back"id ="print" />
