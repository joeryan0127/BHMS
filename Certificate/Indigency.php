...
if(!$id){
    ...
    header('Location: ../Barangayindigency.php');
...
<input type="button" onclick="location.href='../Barangayindigency.php'" style="color:white;background-color:DodgerBlue;padding:0.5%;width=100%;" value="Back"id ="print" />

  <!-- <form method="post" style="Posistion" action="../Barangayindigency.php">
  <button >Back</button>
  </form> -->
