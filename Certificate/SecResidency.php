...
if(!$id){
    ...
    header('Location: ../SecBarangayResidency.php');
...
<button onclick ="window.print();" class="side" name ="Submit"  id ="print" >Print</button>
  ...
  <input type="button" onclick="location.href='../SecBarangayResidency.php'" style="color:white;background-color:DodgerBlue;padding:0.5%;width=100%;" value="Back"id ="print" />
