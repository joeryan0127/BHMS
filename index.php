                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <img src="Pic/nagaakunggarbo.png" class="log1">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="includes/loginad.inc.php" method="post">

                                    <?php
                            if(isset($_GET["error"])){
                                if($_GET["error"]== "Wronglogs"){
                                ...
                                if($_GET["error"]== "Wrongpass"){
                                    ...
                                    if($_GET["error"]== "notApproved"){
                                        echo "<script> alert('Account is Not Approve ');</script>";
                                        }
