...
?>  
                        <div id="London1" class="card-body ">
            ...
            <h5>APPROVED</h5>
                            ...
                            $statement =$conn->prepare('SELECT *from certificate INNER JOIN resident ON certificate.resident_ID  = resident.resident_ID INNER JOIN purok ON certificate.P_id = purok.P_id  WHERE Approve ="Approve" AND Certificate ="Cutting Tree Permit" AND Remarks =""');
                            $statement->execute();
      ...
      <form style ="display: inline-block"method ="POST" action="Certificate/Tree.php">
...
<button type="submit" class="btn btn-sm btn-info" name ="submit" >Print</button>
                ...
                <div id="Paris1" class="card-body ">
                            ...
                            $statement =$conn->prepare('SELECT *from certificate INNER JOIN resident ON certificate.resident_ID  = resident.resident_ID INNER JOIN purok ON certificate.P_id = purok.P_id  WHERE Approve ="Approve" AND Certificate ="Cutting Tree Permit" AND Remarks ="Done"');
                            $statement->execute();
                            while($certificate=$statement->fetch()){
