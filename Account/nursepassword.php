...
if($checkpwd===false){
    header("location: ../nursedash.php?error=WrongCurrentpass");
    echo $checkpwd;
}else if($new1!==$new2){

    header("location: ../nursedash.php?error=Wrongpass");
    ...
    header("location: ../nursedash.php?error=None");

}else{
    header("Location: ../nursedash.php?error=notlowercaase");
    exit();
   }

   }else{
    header("Location: ../nursedash.php?error=not8");
    exit();
