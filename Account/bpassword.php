...
if($checkpwd===false){
    header("location: ../bhwdash.php?error=WrongCurrentpass");
    echo $checkpwd;
}else if($new1!==$new2){

    header("location: ../bhwdash.php?error=Wrongpass");
    ...
    header("location: ../bhwdash.php?error=None");

}else{
    header("Location: ../bhwdash.php?error=notlowercaase");
    exit();
   }

   }else{
    header("Location: ../bhwdash.php?error=not8");
    exit();
