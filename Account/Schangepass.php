...
<div class="modal fade" id="love" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="group32">
                    <form  action="Account/Spassword.php" method="post" enctype="multipart/form-data">
            
                    <input type ="hidden" class = "text1" name= "id" id="id"placeholder ="Position" value="<?php echo $_SESSION["Suid"]; ?>" readonly>
