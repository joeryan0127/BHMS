...
$statement =$conn->prepare("SELECT Count(*) FROM `account` WHERE Remark = ' '");
$statement->execute();
$Account=$statement->fetchColumn();
?>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion yello" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="barangayofficial.php">Manage Officials</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Resident.php">Manage Residence</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilitiesH" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="household.php">Manage Household</a>
                        <!-- <a class="collapse-item" href="utilities-border.html">Borders</a>
                        <a class="collapse-item" href="utilities-animation.html">Animations</a>
                        <a class="collapse-item" href="utilities-other.html">Other</a> -->
                    </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilitiesP" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Purok.php">Manage Purok</a>
                        <!-- <a class="collapse-item" href="utilities-border.html">Borders</a>
                        <a class="collapse-item" href="utilities-animation.html">Animations</a>
                        <a class="collapse-item" href="utilities-other.html">Other</a> -->
                    </div>
         ...
         <!-- Clerances -->
            ...
            <!-- Blotter -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilitiesC"
                    aria-expanded="true" aria-controls="collapses12">
                    <i class="fas fa-fw fa-folder"></i>
  ...
  <span class="badge badge-danger badge-counter"><?php echo "$approve" ?></span>
</a>
                <?php
                      }  else{
...
?>
                ...
                <div id="collapseUtilitiesC" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded"> 
                        <!-- <h6 class="collapse-header">Login Screens:</h6> -->
                        <a class="collapse-item" href="AdminApp.php">Approve Certificate        
                             <!-- <a href="AdminApp.php" class="side103"> -->
                <!-- <i class="fas fa-bell fa-fw"></i>
  <span class="badge badge-danger badge-counter"><?php echo "$approve" ?></span>
</a> -->
<?php 
...
?>
                        ...
                        <a class="collapse-item" href="Admincertificatedash.php">Certificates</a>
            ...
            <!-- account -->
            <!-- <li class="nav-item">
                <a class="nav-link" href="housedash.php">
                <i class="fas fa-house-user"></i> 
                    <span>Household</span></a>
            </li> -->  
              <li class="nav-item">
                <a class="nav-link" href="Adminblotterdash.php">
...
?>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapses1"
                    ...
                    <!-- <a href="#" class="side123">
                <i class="fas fa-bell fa-fw"></i>
  <span class="badge badge-danger badge-counter"><?php echo "$Account" ?></span>
</a> -->
<?php 
                    if($Account>=1){
                    ?>
...
?>
                ...
                <div id="collapses1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <!-- <h6 class="collapse-header">Login Screens:</h6> -->
                        <a class="collapse-item" href="Account.php">Manage Account</a>
                        <a class="collapse-item" href="AccountApp.php">Approve Account

                        <!-- <a href="AccountApp.php" class="side103">
                <i class="fas fa-bell fa-fw"></i>
  <span class="badge badge-danger badge-counter"><?php echo "$Account" ?></span>
</a> -->
...
<!-- CLOSE OPEN -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Chairman/ <?php echo $_SESSION["fullname"] ?></span>
                ...
                <?php
                require_once("Account/viewaccount.php");
    require_once("Account/changepass.php");
    require_once("logout/Alogout.php");
    ?>