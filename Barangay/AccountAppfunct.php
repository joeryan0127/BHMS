<div class="modal fade" id="edit2_<?php echo $certificate['A_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  action="Barangay/AccountApprove.php" method="post" enctype="multipart/form-data">
                    ...
                    <select type ="hidden"  class = "text1" name ="app"   required>
                      ...
                      <label type ="hidden" class ="text2">Do you Want To Approve This Account?</label>    
