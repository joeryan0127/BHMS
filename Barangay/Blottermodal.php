<div class="modal fade" id="edit_<?php echo $Blotter['id']; ?>"tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="group32">
                    <form  action="Barangay/Blotterupdate.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type ="date" class = "text1" name= "date" placeholder ="date"  value="<?php echo $Blotter['Sdate']; ?>"  required>

                    <label class ="text2">Schedule Time</label>            
                    <input type ="time" class = "text1" name= "Time" placeholder ="Time"  value="<?php echo $Blotter['Stime']; ?>"  required>
