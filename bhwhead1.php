    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion yello" id="accordionSidebar">
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href=".html">Residence info</a> -->
         ...
         <!-- Clerances -->
            ...
            <!-- Blotter -->
            <!-- <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#ryan"
                    aria-expanded="true" aria-controls="collapses">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Certificate</span></a>
                </a>
                <div id="ryan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">  -->
                        <!-- <h6 class="collapse-header">Login Screens:</h6> -->
                        <!-- <a class="collapse-item" href="AdminApp.php">Approve Certificate</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Chairman</span>
