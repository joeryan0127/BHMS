<div class="modal fade" id="edit4_<?php echo $Purok['Maternity_id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="group32">
                    ...
                    <input type ="hidden" class = "text1" name= "R_id" value="<?php echo $Purok['resident_ID'] ?>" readonly>
