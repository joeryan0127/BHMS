...
?> 
                        ...
                        <div id="London" class="card-body ">
                            ...
                            $statement =$conn->prepare('SELECT * from certificate INNER JOIN resident ON certificate.resident_ID  = resident.resident_ID INNER JOIN purok ON certificate.P_id = purok.P_id WHERE Approve ="Approve" AND Certificate ="Barangay Residency" AND Remarks =""');
                            $statement->execute();
      ...
      <form style ="display: inline-block"method ="POST" action="Certificate/SecResidency.php">
...
<button type="submit" class="btn btn-sm btn-info" name ="submit" >Print</button>
                ...
                <div id="Paris" class="card-body ">
                            ...
                            $statement =$conn->prepare('SELECT * from certificate INNER JOIN resident ON certificate.resident_ID  = resident.resident_ID INNER JOIN purok ON certificate.P_id = purok.P_id WHERE Approve ="Approve" AND Certificate ="Barangay Residency" AND Remarks ="Done"');
                            $statement->execute();
                            while($certificate=$statement->fetch()){
